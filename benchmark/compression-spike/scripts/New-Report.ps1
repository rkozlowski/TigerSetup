...
W 'Nothing measured here changed the product: TigerSetup 0.7.1, its ZIP/DEFLATE'
W 'payload and its Protocol Buffers schema are untouched, and the Architect decides'
W 'the format separately.'
W ''
